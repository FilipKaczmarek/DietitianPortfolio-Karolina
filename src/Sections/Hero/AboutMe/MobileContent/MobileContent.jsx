...
export const DesktopContent = ({ className }) => {
  return (
    <div
      className={`${
        className ? className : ""
      } h-full grid-cols-3 grid-rows-[1fr_minmax(1fr,_auto)_1fr]`}
    >
      ...
      <div className="col-start-1 col-end-2 row-start-1 row-end-2 justify-self-end place-self-center">
        <h1 className="text-3xl pb-3 italic vertical-writing pr-3 md:hidden">Hello!</h1>
      </div>
      <div className="col-start-1 col-end-4 row-start-2 row-end-3">
        ...
        <p className="pb-3 px-8 md:px-16 text-justify leading-relaxed	md:leading-loose">
